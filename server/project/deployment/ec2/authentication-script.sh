...
sudo docker run -d --name authentication-service -p 50051:50051 931100716322.dkr.ecr.ap-southeast-1.amazonaws.com/ims-repository:authentication-service-latest

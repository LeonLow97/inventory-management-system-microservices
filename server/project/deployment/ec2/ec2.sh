...
# echo "Creating 'authentication_postgres' user and granting privileges..."
# PGPASSWORD=$DB_MASTER_PASSWORD psql -h $RDS_ENDPOINT -U $DB_MASTER_USERNAME -d $IMS_DB_NAME -c "
#   -- Create 'authentication_postgres' user
#   CREATE USER authentication_postgres WITH PASSWORD 'your_secure_password';

#   -- Grant necessary privileges on the imsdb database and public schema
#   GRANT ALL PRIVILEGES ON DATABASE $IMS_DB_NAME TO authentication_postgres;
...
# " || { echo "❌ Failed to create user or grant privileges"; exit 1; }
# echo "✅ Successfully created 'authentication_postgres' user and granted privileges."
...
# Launch Bastion Host EC2 instance in AZ1 (you could deploy one in AZ2 as well if needed)
...
# Optionally, you can launch a Bastion Host instance in AZ2 if needed
